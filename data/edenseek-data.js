...
window.EDEN = {
  ...
  creators: [
    ...
    { slug: "derek-uskert", name: "Derek Uskert", roles: ["Editor-in-Chief"], featured: true, worksOn: ["i-ride-for-them", "egypt-the-cat"], photo: { base: "creator-derek-uskert", w: 400, h: 400, alt: "Derek Uskert, Editor-in-Chief" }, bio: "Derek is an award-winning luxury residential architect and lifelong comic book enthusiast. As Edenseek's Editor-in-Chief, he provides editorial and creative direction across every project — from production and recruiting to conventions — helping bring every story to life." }
  ],
