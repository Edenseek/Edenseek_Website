...
window.EDEN = {
  ...
  creators: [
    ...
    { slug: "derek-uskert", name: "Derek Uskert", roles: ["Editor"], featured: true, worksOn: ["i-ride-for-them", "egypt-the-cat"], photo: { base: "creator-derek-uskert", w: 400, h: 400, alt: "Derek Uskert, Editor" }, bio: "Derek provides editorial and creative direction across every Edenseek project. From recruiting talent and guiding production to representing the company at comic conventions, he helps shape each story from concept to publication." }
  ],
