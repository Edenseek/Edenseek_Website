...
window.EDEN = {
  ...
  creators: [
    ...
    { slug: "michael-bryan-quiambao", name: "Michael Bryan Quiambao", roles: ["Illustrator"], featured: true, worksOn: ["egypt-the-cat"], photo: { base: "creator-michael-bryan-quiambao", w: 400, h: 400, alt: "Michael Bryan Quiambao, Illustrator" }, bio: "Michael is the illustrator of the Egypt the Cat picture-book series." },
    ...
    { slug: "rimanti", name: "Rimanti", roles: ["Cover Artist"], featured: true, worksOn: ["i-ride-for-them"], photo: { base: "creator-placeholder", w: 400, h: 400, alt: "Edenseek — Born Different (placeholder portrait)" }, bio: "Rimanti is a talented and visionary female illustrator from Jakarta, Indonesia, known for her dynamic and expressive art style and a deep passion for visual storytelling. Her personal projects, \"Buckle Up\" and \"Fly Through,\" highlight her creative independence and unique approach to character design and narrative exploration. Rimanti's second project into the international comic scene came with her work on \"Blue Palo Verde\" with Mad Cave Studios." },
    // Letterers
