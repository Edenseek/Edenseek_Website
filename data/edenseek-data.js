...
window.EDEN = {
  ...
  creators: [
    ...
    { slug: "rimanti", name: "Rimanti N.", roles: ["Cover Artist"], featured: true, worksOn: ["i-ride-for-them"], photo: { base: "creator-rimanti", w: 400, h: 400, alt: "Rimanti N., Cover Artist" }, bio: "Rimanti N. is a talented and visionary female illustrator from Jakarta, Indonesia, known for her dynamic and expressive art style and a deep passion for visual storytelling. Her personal projects, \"Buckle Up\" and \"Fly Through,\" highlight her creative independence and unique approach to character design and narrative exploration." },
    // Letterers
